...
export default class Formatter extends React.Component<{
    ...
    private getItem() {
        ...
        switch (formatAs) {
            case "string":
                return <FormattedMessage id={key} description={this.props.description} defaultMessage={this.props.defaultMessage} values={this.props.value} />;
            ...
            case "fromNow":
                const fromNowValue = typeof this.props.value === "number" ? new Date(this.props.value) : this.props.value;
